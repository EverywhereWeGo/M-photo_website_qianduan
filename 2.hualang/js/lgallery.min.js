...
!function () {
    function t(e) {
        if (++t.prototype._count < 2) {
            ...
            if (!document.head.querySelector('[href="lgallery.min.css"]')) {
                ...
                l.rel = "stylesheet", l.href = "2.hualang/css/lgallery.min.css", document.head.appendChild(l)
            }
        }
    ...
    t.prototype._count = 0, t.prototype._createLink = function () {
        ...
        if ("lgparent" == this._type) for (var e = 0; e < this._src.length; e++) this._src[e].addEventListener("click", this._initGallery.bind(this)), this._src[e].style.cursor = "pointer";
